...
public class Admin_MenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        CursosTable1 = new javax.swing.JTable();
        ...
        if (selecPreviaCurTable.getColumnModel().getColumnCount() > 0) {
            selecPreviaCurTable.getColumnModel().getColumn(2).setHeaderValue("Tipo de previa");
        }
        ...
        jScrollPane12.setViewportView(DescCarrTextArea);
        ...
        jLabel46.setText("Seleccionar sede:");
        ...
        jScrollPane16.setViewportView(selecSedeCarrTable);

        CursosTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane15.setViewportView(CursosTable1);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(PanelCabecera, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                .addComponent(PanelPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 482, Short.MAX_VALUE))
        );
    ...
    private void ConfirmarCurButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfirmarCurButtonActionPerformed
        ...
        if(nombre.isEmpty()||descripcion.isEmpty()||horario.isEmpty()||creditos.trim().isEmpty()){
            ...
            try {
                ...
                Fabrica.getInstance().getContEdu().nuevoCurso(nombre, Integer.valueOf(creditosCurTextField.getText()), semestre, descripcion, horario, optativo, c);
        ...
        switch (opcion) {
            ...
            case "crearCurso":
                if(NombreCarrTextField.getText().isEmpty()){
                    ...
                    // Si no esta vacio es porque se esta creando la carrera
    ...
    private javax.swing.JTable CursosTable1;
